...
public class TouchImageView extends ImageView {
    ...
    static final int screenWidth_= Utilities.getScreenPxWidth();
                ...
                switch (event.getAction() & MotionEvent.ACTION_MASK) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (xDiff < CLICK && yDiff < CLICK) {
                            ...
                            if (pressTime - lastPressTime <= DOUBLE_PRESS_INTERVAL) {
                                ...
                                if (saveScale == 1)
                                {
                                    final float targetScale =screenWidth_ /origWidth;
                                   /* final float targetScale = maxScale / saveScale;
                                    matrix.postScale(targetScale, targetScale, start.x, start.y);
                                    saveScale = maxScale;*/
                                    matrix.postScale(targetScale, targetScale,  width / 2, height / 2);
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (mode == DRAG) {
                            ...
                            checkAndSetTranslate(0, deltaY);
                            lastDelta.set(0, deltaY);
