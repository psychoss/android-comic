...
//            req.method(Method.GET);
//            req.timeout(15000);
           // req.header("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11");
            HttpURLConnection conn = (HttpURLConnection) req.url().openConnection();//createConnection(req);
