...
public class Elements implements List<Element>, Cloneable {
    ...
    /**
     * Get the {@link org.jsoup.nodes.FormElement} forms from the selected elements, if any.
     * @return a list of {@link org.jsoup.nodes.FormElement}s pulled from the matched elements. The list will be empty if the elements contain
     * no forms.
     */
